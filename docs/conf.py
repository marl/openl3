...
MOCK_MODULES = [
    'numpy', 'soundfile', 'resampy', 'keras', 'tensorflow', 'kapre'
]
...
import imp
openl3_version = imp.load_source('openl3.version', '../openl3/version.py')
version = openl3_version.short_version
# The full version, including alpha/beta/rc tags
release = openl3_version.version
